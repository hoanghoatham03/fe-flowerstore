...
const Footer = () => {
    return (
      <footer className="w-full bg-[#c3e6cb] mt-5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
          <div className="py-14 grid grid-cols-12 gap-x-5 gap-y-8">
            <div className="col-span-full xl:col-span-3 relative bg-[#bee5eb] border-2 border-black rounded-2xl gap-12 p-6 xl:w-72 h-96 flex flex-col justify-center items-center">
            ...
            <div className="block text-center xl:text-left xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3 xl:pl-5">
              ...
              <ul className="text-gray-600 transition-all duration-500 grid gap-6 text-ms">
                ...
                <li className='flex flex-row items-center gap-1'><MapPinIcon className='w-12'/> Quarter 6, Linh Trung Ward, Thu Duc City, Ho Chi Minh City.</li>
              </ul>
            </div>
