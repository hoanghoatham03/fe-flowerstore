    ...
    <div className="py-16 bg-[#FDEDEC] min-h-screen items-center justify-center">
      <div className="flex bg-white rounded-lg shadow-lg overflow-hidden m-auto max-w-sm lg:max-w-4xl">
        <div
          ...
          style={{
            backgroundImage:
              "url('assets/login-img.jpg')",
          }}
        ></div>

        <div className="w-full p-8 lg:w-1/2">
          <h2 className="text-2xl font-semibold text-gray-700 text-center">MoonFlower</h2>
          <p className="text-xl text-gray-600 text-center">Chào mừng đến với MoonFlower</p>
